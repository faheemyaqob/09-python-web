...
# ============================================
st.set_page_config(
    page_title="Faheem Gujjar | Portfolio",
    page_icon="🌟",
    layout="wide",
...
with col2:
    ...
    # Social badges
    st.write("""
    [![LinkedIn](https://img.shields.io/badge/LinkedIn-0077B5?logo=linkedin)](https://www.linkedin.com/feed/)
    [![GitHub](https://img.shields.io/badge/GitHub-181717?logo=github)](https://github.com/faheemyaqob)
...
with about_col1:
    ...
    st.write("""
    🎓 **Intermediate**  
    Govt.Degree Boys Collage Korangi 6
    2023 - 2024
    """)
...
with st.expander("🔍 Project 1: BMI Calculator", expanded=True):
    ...
    with proj_col2:
        ...
        st.link_button("https://usamakhan777-hangman-game-hang-man-u5hvku.streamlit.app/")
...
with st.expander("📊 Project 2: Cooldown Timer"):
    ...
    with proj_col2:
        ...
        """)
        st.link_button("View code on Github", "https://github.com/faheemyaqob/04rock-project")
        st.link_button("")
...
contact_form = """
<form action="https://github.com/faheemyaqob" method="POST">
...
# ============================================
st.markdown("---")
st.markdown("© 2025 Faheem Gujjar | Made with Streamlit")